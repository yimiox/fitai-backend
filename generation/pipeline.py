...
from generation.llm_client import generate_plan          # ← was call_claude
from generation.parser import parse_and_validate, enrich_citations, PlanValidationError
...
# ─────────────────────────────────────────────
# CORE: Generate plan with retry loop
# ─────────────────────────────────────────────
